...
def generate_pdbs():
    ...
    for index in pi_df.index:
        if pi_df.loc[index, 'rank'] == '0':
            with open(results_data_path + '\\' + pi_df.loc[
                index, 'protA_protB'] + '\\' + 'ranking_debug.json') as ranking_json:
                ...
                for index2 in pi_df.index:
                    if pi_df.loc[index2, 'rank'] == '0' and (
                            pi_df.loc[index2, 'protA_protB'] == pi_df.loc[index, 'protA_protB']):
                        pi_df.loc[index2, 'pLDDT'] = ranks[0]
                    if pi_df.loc[index2, 'rank'] == '1' and (
                            pi_df.loc[index2, 'protA_protB'] == pi_df.loc[index, 'protA_protB']):
                        pi_df.loc[index2, 'pLDDT'] = ranks[1]
                    if pi_df.loc[index2, 'rank'] == '2' and (
                            pi_df.loc[index2, 'protA_protB'] == pi_df.loc[index, 'protA_protB']):
                        pi_df.loc[index2, 'pLDDT'] = ranks[2]
                    if pi_df.loc[index2, 'rank'] == '3' and (
                            pi_df.loc[index2, 'protA_protB'] == pi_df.loc[index, 'protA_protB']):
                        pi_df.loc[index2, 'pLDDT'] = ranks[3]
                    if pi_df.loc[index2, 'rank'] == '4' and (
                            pi_df.loc[index2, 'protA_protB'] == pi_df.loc[index, 'protA_protB']):
